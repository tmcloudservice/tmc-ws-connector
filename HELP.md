...
* The original package name 'com.tmc.websocket.connector.tmc-ws-connector' is invalid and this project uses 'com.tmc.websocket.connector.tmcwsconnector' instead.
